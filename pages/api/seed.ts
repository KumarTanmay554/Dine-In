...
export default async function handler(
  ...
  await prisma.bookingOnTables.deleteMany();
  ...
  await prisma.restaurant.createMany({
    data: [
      ...
      },
      {
        ...
        price: PRICE.REGULAR,
        description:
          "Welcome to Last Train to Delhi. We are a progressive Indian restaurant in the beautiful Glebe community in Ottawa. Our speciality is Northern Indian food, classics like Murg Mahkini and some modern dishes like Crispy Shrimp. We are a small cozy restaurant, so make sure that you reserve through Dine In.",
        image: [
